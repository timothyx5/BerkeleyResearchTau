...
uv_z = np.array([5.000000e-02, 3.000000e-01, 5.000000e-01, 7.000000e-01, 1.000000e+00, 4.000000e-02, 1.300000e-01,
...
uv_data = np.array([-1.797000e+00,-1.392000e+00,-1.282000e+00,-1.092000e+00,-1.142000e+00,-1.743000e+00,
                    -1.735000e+00,-1.526000e+00,-1.423500e+00,-1.231500e+00,-9.830200e-01,-9.311500e-01,
                    -9.322000e-01,-7.112000e-01,-9.624000e-01,-1.530000e+00,-9.474000e-01,-6.774000e-01,
                    -7.974000e-01,-5.900000e-01,-8.100000e-01,-1.138000e+00,-1.345000e+00,-1.576000e+00,
                    -1.600000e+00,-1.648000e+00,-1.909000e+00,-1.782000e+00,-1.915000e+00,-1.988000e+00,
                    -2.324000e+00,-2.406000e+00])
uv_data = 10**uv_data
uv_err_up = np.array([ 4.000000e-02 , 1.500000e-01, 1.500000e-01,2.300000e-01,
                       2.300000e-01 , 1.000000e-01, 1.900000e-01,1.300000e-01,
                       1.100000e-01 , 1.100000e-01, 9.100000e-02,9.300000e-02, 
                       1.000000e-01 , 1.000000e-01, 1.700000e-01,3.600000e-01,
                       1.500000e-01 , 1.900000e-01, 1.600000e-01,1.400000e-01,
                       1.900000e-01 , 7.200000e-02, 8.500000e-02,1.300000e-01, 
                       2.100000e-01 , 1.500000e-01, 4.200000e-01,2.500000e-01,
                       2.700000e-01 , 3.900000e-01, 6.300000e-01,7.400000e-01])
uv_err_up = uv_data * 10**uv_err_up - uv_data
uv_err_low = uv_data * 10**-uv_err_up - uv_data
          
#IR data from Brant Robertson recomputed from MD14
ir_z    = np.array([3.000000e-02, 3.000000e-02, 5.500000e-01, 8.500000e-01, 1.150000e+00, 1.550000e+00, 2.050000e+00, 5.500000e-01,
...
ir_data = np.array([-1.652500e+00,-1.882500e+00,-1.272500e+00,-8.925000e-01,-8.225000e-01,-8.425000e-01,-8.225000e-01,
           -1.152500e+00,-1.032500e+00,
           -8.925000e-01,-8.725000e-01,-7.325000e-01,-1.634650e+00,-1.412410e+00,-1.312410e+00,-1.132410e+00,
           -9.324100e-01,-8.024100e-01,
           -8.324100e-01,-8.524100e-01,-9.024100e-01,-8.524100e-01,-1.352410e+00])
ir_data = 10**ir_data
ir_err_up = np.array([ 1.000000e-01,2.030000e-01,1.700000e-01,2.500000e-01,
              2.700000e-01,2.700000e-01,3.100000e-01,1.700000e-01,
              1.900000e-01,2.600000e-01,2.400000e-01,2.100000e-01,
              1.153500e-01,4.759000e-02,5.759000e-02,6.759000e-02,
              5.759000e-02,5.759000e-02,4.759000e-02,3.759000e-02,
              1.275000e-01,2.375000e-01,5.076000e-01 ])
ir_err_up = ir_data * 10**ir_err_up - ir_data
ir_err_low =  ir_data * 10**-ir_err_up - ir_data
